...
Write-Host "`nOrbit Flutter UI Runtime Polish v3 installed." -ForegroundColor Green
Write-Host "Run: .\tool\verify-ui-runtime-polish-v3.ps1 -FlutterProjectPath `"$FlutterProjectPath`""
