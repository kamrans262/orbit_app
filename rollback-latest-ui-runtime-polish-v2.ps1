...
# v2 may add a verifier that did not exist in the original baseline.
Remove-Item (Join-Path $FlutterProjectPath "tool\verify-ui-runtime-polish-v2.ps1") -Force -ErrorAction SilentlyContinue
